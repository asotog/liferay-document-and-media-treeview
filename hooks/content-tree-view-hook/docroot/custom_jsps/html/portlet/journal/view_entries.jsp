...
<%@ include file="/html/portlet/journal/view_entries_tree.jspf" %>
				...
				<c:when test='<%= !displayStyle.equals("list") %>'>
					...
					<c:choose>
						...
						<c:when test='<%= displayStyle.equals(TREE_VIEW) %>'>
							<liferay-util:include page="/html/portlet/journal/view_article_tree.jsp" />
						</c:when>
						<%-- RivetLogic Custom ENDS --%>
						<c:otherwise>
			...
			<c:choose>
				<c:when test='<%= !displayStyle.equals("list") %>'>
					...
					<c:choose>
						...
						<%-- RivetLogic Custom BEGINS --%>
						<c:when test='<%= displayStyle.equals(TREE_VIEW) %>'>
							<liferay-util:include page="/html/portlet/journal/view_folder_tree.jsp" />
						</c:when>
						<%-- RivetLogic Custom ENDS --%>
						<c:otherwise>
